    ...
    return (
      <div>
        <div className="med-home start-area">
          <Link className="special-btn" to="/meditate">
        ...
        <div className="med-home profile-area">
          <div className="inner">
            ...
            <p>
              ...
              dignissimos labore dicta unde, nam suscipit tempore sapiente
              cumque vitae facilis enim reprehenderit nobis veniam consequatur
              ipsum distinctio, iusto accusamus, aliquid quos incidunt tenetur
              magni repudiandae blanditiis magnam? Consectetur, laboriosam
              deleniti? Dolor doloremque rerum eius corporis qui repellendus
              quod quasi cumque.
            </p>
          </div>
        </div>
        <div className="med-home med-logs">
          ...
          <div className="med-log-list">
            {this.props.userSessions.map((logData) => {
              return <SessionLog data={logData} />
            })}
          </div>
        </div>
      </div>
...
export default connect(mapStateToProps, { fetchUserSessions })(Main)
